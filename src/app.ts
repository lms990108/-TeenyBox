...
import accessLogStream from "./common/utils/log";
...
if (process.env.NODE_ENV === "production") {
  app.use(morgan("combined", { stream: accessLogStream })); // morgan: 로그를 찍어주는 미들웨어, 서버에 요청이 어떻게 들어오는지 보기 편하고 로그를 남겨서 디버깅에 용이
} else {
